...
void GameManager::updateMouseInput()
{
    ...
    this->xoffset = this->xpos - this->lastX;
    this->yoffset = this->lastY - this->ypos; // reversed since y-coordinates go from bottom to top
...
void GameManager::scroll_callback()
{
    this->camera.ProcessMouseScroll(this->yoffset);
}
