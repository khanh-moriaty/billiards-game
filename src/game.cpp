...
void GameManager::createObjects()
{
    ...
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball0"], glm::vec3(0.f, 1.0f, 0.f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball1"], glm::vec3(0.f, 1.0f, 0.1f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball2"], glm::vec3(0.f, 1.0f, 0.2f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball3"], glm::vec3(0.f, 1.0f, 0.3f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball4"], glm::vec3(0.1f, 1.0f, 0.0f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball5"], glm::vec3(0.2f, 1.0f, 0.f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball6"], glm::vec3(0.3f, 1.0f, 0.0f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball7"], glm::vec3(0.1f, 1.0f, 0.1f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball8"], glm::vec3(0.2f, 1.0f, 0.2f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball9"], glm::vec3(0.3f, 1.0f, 0.3f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball10"], glm::vec3(0.2f, 1.0f, 0.3f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball11"], glm::vec3(0.3f, 1.0f, 0.2f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball12"], glm::vec3(0.1f, 1.0f, 0.2f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball13"], glm::vec3(0.2f, 1.0f, 0.1f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball14"], glm::vec3(0.1f, 1.0f, 0.3f)));
    this->mesh.push_back(new Mesh(ball_primitive, textureManager["ball15"], glm::vec3(0.3f, 1.0f, 0.1f)));
